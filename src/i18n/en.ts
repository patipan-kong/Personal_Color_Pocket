...
export const en: LocaleCopy = {
  ...
  daily: {
    ...
    goalPrompt: 'What would you like to focus on today?',
    goals: { work: 'Work', money: 'Money', luck: 'Luck & opportunity', 'mentor-support': 'Mentor support' },
    resultEyebrow: "Today's suggested lucky color", familyLabel: 'Lucky color family',
    ...
    generalNote: 'Personalization is not available yet. This is a broad lucky-color outfit idea.', quizCta: 'Find your Personal Color',
    ...
    aboutHeading: "About today's lucky colors", aboutBody: 'This is cultural belief guidance based on a Thai daily lucky-color tradition. Personal Color changes the shade or placement, never the lucky color family.',
