...
export const en: LocaleCopy = {
  ...
  daily: {
    ...
    eyebrow: 'Daily color guide', title: 'What should I wear today?', today: 'Today',
    ...
    resultEyebrow: "Today's suggested lucky color(s)", familyLabel: 'Lucky color family',
    ...
    personalizedShade: 'Personalized expression', personalizedFor: (subtype) => `Adapted for your ${subtype} Personal Color.`,
    ...
    outfitEyebrow: 'Outfit guidance', outfitHeading: 'A simple way to wear it',
