...
export const en: LocaleCopy = {
  ...
  daily: {
    entryCta: "See today's lucky color",
    title: 'What should I wear today?', today: 'Today',
    weekdays: { sun: 'Sunday', mon: 'Monday', tue: 'Tuesday', wed: 'Wednesday', thu: 'Thursday', fri: 'Friday', sat: 'Saturday' },
    framing: "Today's color is based on a Thai lucky-color tradition and adapted to your Personal Color when available.",
    goalPrompt: 'What would you like to focus on today?', goalLimit: 'Choose up to 2', goalSeparator: ' · ',
    goals: { work: 'Work', money: 'Money', luck: 'Luck & opportunity', 'mentor-support': 'Mentor support' },
    resultEyebrow: "Today's colors", familyLabel: 'Lucky color family',
    familyLabels: { white: 'White', yellow: 'Yellow', pink: 'Pink', red: 'Red', green: 'Green', blue: 'Blue', purple: 'Purple', orange: 'Orange', gray: 'Gray', black: 'Black' },
    personalizedShade: 'Your shade', personalizedFor: (subtype) => `Adapted for your ${subtype} Personal Color.`,
    generalNote: 'Personalization is not available yet. These are broad lucky-color outfit ideas.', quizCta: 'Find your Personal Color',
    placementNotes: { 'main-piece': 'Today’s lucky color works best as the main piece of your outfit.', 'below-face': 'Your Personal Color works better near your face, so today’s lucky color moves below the face.', accessory: 'Use today’s lucky color as a small accessory; your Personal Color stays closest to your face.' },
    outfitEyebrow: "Today's look", outfitHeading: 'How to wear it',
    storyFamily: 'The lucky color says which color.', storyShade: 'Personal Color picks the shade and where to wear it.', boardLabel: 'Outfit pieces',
    pieceLabels: { top: 'Top', bottom: 'Bottom', shoes: 'Shoes', accessory: 'Accessory' }, luckyBadge: 'Lucky color', personalSupport: 'Personal Color', neutralSupport: 'Supporting neutral',
    semanticColors: { 'light-neutral': 'Light neutral', neutral: 'Neutral' },
    aboutHeading: "About today's lucky colors", aboutBody: 'This is cultural belief guidance based on a Thai daily lucky-color tradition. You can choose up to two independent goal colors; the product composes them into one outfit. Personal Color changes shades or placement, never the lucky color family.',
    sourcesLabel: 'Sources', sourceJoin: 'with corroboration from', dateError: 'We could not read a valid device date. Please check your device clock and try again.',
  },
