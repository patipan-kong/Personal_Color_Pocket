...
export const en: LocaleCopy = {
  ...
  daily: {
    ...
    framing: 'Lucky colors follow a Thai daily tradition and are adapted to your Personal Color when available.',
    ...
    resultEyebrow: (count) => count > 1 ? "Today's colors" : "Today's color", familyLabel: 'Lucky color family',
    ...
    generalNote: 'No Personal Color result yet, so these are broad lucky-color ideas.', quizCta: 'Find your Personal Color',
    placementNotes: { 'main-piece': 'works best as the main piece of your outfit.', 'below-face': 'sits below your face, so your Personal Color shades stay closest to it.', accessory: 'works best as a small accessory, so your Personal Color shades stay closest to your face.' },
    outfitEyebrow: "Today's look", outfitHeading: 'How to wear it',
    storyFamily: 'Thai tradition picks the lucky color.', storyShade: 'Your Personal Color picks the shade and where to wear it.', boardLabel: 'Outfit pieces',
    pieceLabels: { top: 'Top', bottom: 'Bottom', shoes: 'Shoes', accessory: 'Accessory' }, luckyBadge: 'Lucky color', personalSupport: 'From your Personal Color', neutralSupport: 'Supporting neutral',
