...
export const learnEn: LearnCopy = {
  ...
  typeDetail: {
    ...
    thisTypes: 'this type’s',
  },
  visuals: {
    illustration: 'Illustration',
    yourColors: 'Your colors',
    exampleColors: 'Example colors',
    placement: {
      nearFace: 'Near your face',
      belowFace: 'Below your face',
      metal: 'A metal as a finishing detail',
      moreConsidered: 'A More Considered color, lower down or in a smaller piece',
    },
    shift: {
      nearFace: 'Near your face',
      moved: 'Lower and smaller, with a Best color on top',
      same: 'The same color in both outfits. Only where it sits has changed.',
    },
    lighting: {
      manual: 'You choose the color yourself.',
      photo: 'The app reads the pixels where you tap.',
      garment: 'One light, soft-colored shirt in four photos',
      warm: 'Warm light',
      cool: 'Cool light',
      shade: 'Shade',
      context: 'Strong colors nearby',
    ...
    lucky: {
      ...
      place: 'Placement',
      placeBody: 'Personal Color picks where to wear it.',
      note: 'An example of how Daily works, not today’s lucky color.',
    },
  },
}
